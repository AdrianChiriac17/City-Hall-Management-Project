        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CitizenProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Requests_CitizenProfiles_CitizenProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeInDepartments", x => new { x.EmployeeProfileId, x.DepartmentId });
                    table.ForeignKey(
                        name: "FK_EmployeeInDepartments_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeInDepartments_EmployeeProfiles_EmployeeProfileId",
                        column: x => x.EmployeeProfileId,
                        principalTable: "EmployeeProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeInDepartments_EmployeeProfiles_ReportsToEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestAssignments", x => new { x.RequestId, x.EmployeeProfileId });
                    table.ForeignKey(
                        name: "FK_RequestAssignments_EmployeeProfiles_EmployeeProfileId",
                        column: x => x.EmployeeProfileId,
                        principalTable: "EmployeeProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequestDocuments", x => new { x.RequestId, x.DocumentId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequestHistory_AspNetUsers_ChangedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeInDepartments_ReportsToEmployeeId",
                table: "EmployeeInDepartments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestAssignments_EmployeeProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_CitizenProfileId",
                table: "Requests",
